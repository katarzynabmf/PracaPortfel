...
namespace Portfel.Testy
{
    public class UnitTest
    {
        ...
        public void TestWyplacSrodkiZKonta()
        {
            ...
            // when
            var portfelSerwis = new PortfelSerwis(mockContext.Object);
            var portfel = new Data.Data.Portfel() { KontoGotowkowe = new KontoGotowkowe() { StanKonta = 200, OperacjeGotowkowe = new List<OperacjaGotowkowa>() }, Pozycje = new List<Pozycja>(), Transakcje = new List<TransakcjaNew>() };
